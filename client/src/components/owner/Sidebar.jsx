...
const Sidebar = () => {
  ...
  return (
    <div className='relative min-h-screen md:flex flex-col items-start pt-8 pl-4
    max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
      ...
      <div className="group relative">
        <label htmlFor="image">
            ...
            <div className="absolute hidden top-0 left-1/2 -translate-x-1/2 h-9 md:h-14 w-9 md:w-14 bg-black/10
        ...
        <div>
            {image && (
                ...
                text-primary cursor-pointer' onClick={updateImage}>Save <img src={assets.check_icon} width={13}
                /></button>
            )}
