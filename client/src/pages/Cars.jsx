...
const Cars = () => {
  ...
  //geeting search params from url
  ...
  return (
    <div>
      ...
      className="flex flex-col items-center py-20 bg-light max-md:px-4">
        ...
        vehicles avilable for your next adventure" />
        ...
        rounded-full shadow">
          ...
          <input onChange={(e) => setInput(e.target.value)} value={input} type="text" placeholder = "Search by make , model or features" className="w-full h-full
